...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
	...
	protected void buildRecipes(@NotNull Consumer<FinishedRecipe> pWriter) {
		...
		ShapedRecipeBuilder.shaped(RecipeCategory.BUILDING_BLOCKS, ModBlocks.OBSIDIAN_PRESSURE_PLATE.get(),2)
			.pattern("OO")
			.define('O', Blocks.OBSIDIAN)
			.unlockedBy(getHasName(Blocks.OBSIDIAN), has(Blocks.OBSIDIAN))
			.save(pWriter);
		stonecutterResultFromBase(pWriter, RecipeCategory.BUILDING_BLOCKS, ModBlocks.OBSIDIAN_PRESSURE_PLATE.get(), Blocks.OBSIDIAN);
